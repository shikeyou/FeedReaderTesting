         ...
         */
         ...
         beforeEach(function(done) {
            ...
            loadFeed(0, function() {
                ...
                // store content from this first feed
                content = $('.feed .entry h2').text();

                // then load the second feed to change the contents
                loadFeed(1, function() {
         ...
         it('should change the content', function(done) {
            ...
            // get content from newly loaded feed
            var newContent = $('.feed .entry h2').text();

            // check new content is not the same as the stored content
